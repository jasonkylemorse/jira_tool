...
#             print(type)
            jql = ' ' .join(['project=spui+AND+issueType="' + type + '"+and+status+was+in+("' + status + '")+ON+endofDay(' + str(loop_day) + ')'])  # Combine the vars for the JQL query
...
#             print(run)
            ...
            print(day, "\t", status, "\t", type, "\t", total)  # Print a tab seperated list of results
#             print(total,end="\t")
#     print()            
